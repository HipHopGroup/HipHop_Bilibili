...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) BiliApplication.getInstance().getApplicationContext().getSystemService(Context.CONNECTIVITY_SERVICE);
...
//        SnackBarUtil.show("已复制到剪贴板");
    ...
    public static int dp2px(float dpValue) {
        final float scale = BiliApplication.getInstance().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
